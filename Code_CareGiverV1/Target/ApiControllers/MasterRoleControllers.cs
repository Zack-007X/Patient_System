...
{
    [Route("api/v{version:apiVersion}/MasterRole")]
    [ApiVersion("1.0")]
    [ApiController]
    [Produces("application/json")]
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล MasterRole")]

    public class MasterRoleController : BaseController
    {
        #region Private Variables
        private ILogger<MasterRoleController> _logger;
        private IMasterRoleService _repository;
        ...
        public MasterRoleController(
            ILogger<MasterRoleController> logger, 
            IMasterRoleService repository, 
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(MasterRoleWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ MasterRole สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล MasterRole โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<MasterRoleViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]MasterRoleSearchModel model)
        {
            try
            {
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("MasterRole_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> MasterRole_report([FromQuery] MasterRoleReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] MasterRoleInputModel model)
        {
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] MasterRoleInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง MasterRole ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<MasterRoleInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
