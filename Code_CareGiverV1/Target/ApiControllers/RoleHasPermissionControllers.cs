...
namespace App.Controllers
{
    ...
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล RoleHasPermission")]

    public class RoleHasPermissionController : BaseController
    {
        #region Private Variables
        private ILogger<RoleHasPermissionController> _logger;
        private IRoleHasPermissionService _repository;
        ...
        public RoleHasPermissionController(
            ILogger<RoleHasPermissionController> logger, 
            IRoleHasPermissionService repository, 
        ...
        /// <summary>
        /// ดึงข้อมูล RoleHasPermission โดย id
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(RoleHasPermissionWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ RoleHasPermission สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล RoleHasPermission โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]RoleHasPermissionSearchModel model)
        {
            try
            {
		...
		/// <summary>
        /// ดึงข้อมูลรายงาน RoleHasPermission
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <returns>Return list of items by specifced keyword</returns>
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("RoleHasPermission_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> RoleHasPermission_report([FromQuery] RoleHasPermissionReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] RoleHasPermissionInputModel model)
        {
        ...
        /// <summary>
        /// ปรับปรุงข้อมูล RoleHasPermission
        /// </summary>
        /// <remarks>
        /// </remarks>
		/// <param name="id"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] RoleHasPermissionInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง RoleHasPermission ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<RoleHasPermissionInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
