...
{
    [Route("api/v{version:apiVersion}/UserHasSpecial")]
    [ApiVersion("1.0")]
    [ApiController]
    [Produces("application/json")]
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล UserHasSpecial")]

    public class UserHasSpecialController : BaseController
    {
        #region Private Variables
        private ILogger<UserHasSpecialController> _logger;
        private IUserHasSpecialService _repository;
        ...
        public UserHasSpecialController(
            ILogger<UserHasSpecialController> logger, 
            IUserHasSpecialService repository, 
        ...
        /// <summary>
        /// ดึงข้อมูล UserHasSpecial โดย id
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(UserHasSpecialWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ UserHasSpecial สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล UserHasSpecial โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<UserHasSpecialViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]UserHasSpecialSearchModel model)
        {
            try
            {
		...
		/// <summary>
        /// ดึงข้อมูลรายงาน UserHasSpecial
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <returns>Return list of items by specifced keyword</returns>
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("UserHasSpecial_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UserHasSpecial_report([FromQuery] UserHasSpecialReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] UserHasSpecialInputModel model)
        {
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] UserHasSpecialInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง UserHasSpecial ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<UserHasSpecialInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
