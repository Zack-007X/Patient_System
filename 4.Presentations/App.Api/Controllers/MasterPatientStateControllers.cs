...
{
    [Route("api/v{version:apiVersion}/MasterPatientState")]
    [ApiVersion("1.0")]
    [ApiController]
    [Produces("application/json")]
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล MasterPatientState")]

    public class MasterPatientStateController : BaseController
    {
        #region Private Variables
        private ILogger<MasterPatientStateController> _logger;
        private IMasterPatientStateService _repository;
        ...
        public MasterPatientStateController(
            ILogger<MasterPatientStateController> logger, 
            IMasterPatientStateService repository, 
        ...
        /// <summary>
        /// ดึงข้อมูล MasterPatientState โดย id
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(MasterPatientStateWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ MasterPatientState สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล MasterPatientState โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<MasterPatientStateViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]MasterPatientStateSearchModel model)
        {
            try
            {
		...
		/// <summary>
        /// ดึงข้อมูลรายงาน MasterPatientState
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <returns>Return list of items by specifced keyword</returns>
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("MasterPatientState_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> MasterPatientState_report([FromQuery] MasterPatientStateReportRequestModel model)
        {
            try
            {				
        ...
        /// <summary>
        /// เพิ่มข้อมูล MasterPatientState
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] MasterPatientStateInputModel model)
        {
        ...
        /// <summary>
        /// ปรับปรุงข้อมูล MasterPatientState
        /// </summary>
        /// <remarks>
        /// </remarks>
		/// <param name="id"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] MasterPatientStateInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง MasterPatientState ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<MasterPatientStateInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
