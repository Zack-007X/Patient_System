...
namespace App.Controllers
{
    ...
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล Survey")]

    public class SurveyController : BaseController
    {
        #region Private Variables
        private ILogger<SurveyController> _logger;
        private ISurveyService _repository;
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(SurveyWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ Survey สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<SurveyViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]SurveySearchModel model)
        {
            try
            {
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("Survey_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Survey_report([FromQuery] SurveyReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] SurveyInputModel model)
        {
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] SurveyInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง Survey ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<SurveyInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
