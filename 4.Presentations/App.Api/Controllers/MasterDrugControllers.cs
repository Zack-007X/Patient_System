...
{
    [Route("api/v{version:apiVersion}/MasterDrug")]
    [ApiVersion("1.0")]
    [ApiController]
    [Produces("application/json")]
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล MasterDrug")]

    public class MasterDrugController : BaseController
    {
        #region Private Variables
        private ILogger<MasterDrugController> _logger;
        private IMasterDrugService _repository;
        ...
        public MasterDrugController(
            ILogger<MasterDrugController> logger, 
            IMasterDrugService repository, 
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(MasterDrugWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ MasterDrug สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล MasterDrug โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<MasterDrugViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]MasterDrugSearchModel model)
        {
            try
            {
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("MasterDrug_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> MasterDrug_report([FromQuery] MasterDrugReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] MasterDrugInputModel model)
        {
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] MasterDrugInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง MasterDrug ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<MasterDrugInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
