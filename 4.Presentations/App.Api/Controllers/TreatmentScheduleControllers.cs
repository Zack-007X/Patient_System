...
{
    [Route("api/v{version:apiVersion}/TreatmentSchedule")]
    [ApiVersion("1.0")]
    [ApiController]
    [Produces("application/json")]
    [Authorize]
    [SwaggerTag("บริหารจัดการข้อมูล TreatmentSchedule")]

    public class TreatmentScheduleController : BaseController
    {
        #region Private Variables
        private ILogger<TreatmentScheduleController> _logger;
        private ITreatmentScheduleService _repository;
        ...
        public TreatmentScheduleController(
            ILogger<TreatmentScheduleController> logger, 
            ITreatmentScheduleService repository, 
        ...
        /// <summary>
        /// ดึงข้อมูล TreatmentSchedule โดย id
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [HttpGet("{id}")]
        [ProducesResponseType(typeof(TreatmentScheduleWithSelectionViewModel), 200)]
		...
		/// <summary>
        /// ดึงรายการเปล่าของ TreatmentSchedule สำหรับการสร้างฟอร์มเปล่า
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        /// <summary>
        /// ดึงข้อมูล TreatmentSchedule โดยการค้นหา
        /// </summary>
        /// <remarks>
        /// </remarks>
        ...
        [ProducesResponseType(typeof(List<TreatmentScheduleViewModel>), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> GetListBySearch([FromQuery]TreatmentScheduleSearchModel model)
        {
            try
            {
		...
		/// <summary>
        /// ดึงข้อมูลรายงาน TreatmentSchedule
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <returns>Return list of items by specifced keyword</returns>
        ...
        /// <response code="401">ไม่มีสิทธิในการใช้งาน</response>
        /// <response code="500">มีข้อผิดพลาดในการทำงานจากระบบ</response>  
        [HttpGet("TreatmentSchedule_report")]
        [ProducesResponseType(typeof(FileStreamResult), 200)]
        [ProducesResponseType(401)]
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> TreatmentSchedule_report([FromQuery] TreatmentScheduleReportRequestModel model)
        {
            try
            {				
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Insert([FromBody] TreatmentScheduleInputModel model)
        {
        ...
        /// <summary>
        /// ปรับปรุงข้อมูล TreatmentSchedule
        /// </summary>
        /// <remarks>
        /// </remarks>
		/// <param name="id"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> Update(Guid id, [FromBody] TreatmentScheduleInputModel model)
        {
            if (ModelState.IsValid)
            {
                try
		...
		/// <summary>
        /// ปรับปรุง TreatmentSchedule ข้อมูลทีละหลายรายการ
        /// </summary>
        /// <remarks>
        /// </remarks>
        /// <param name="model"></param>
        ...
        [ProducesResponseType(500)]
        //[ValidateAntiForgeryToken]
        public async Task<IActionResult> UpdateMultiple([FromBody] List<TreatmentScheduleInputModel> model)
        {
            if (ModelState.IsValid)
            {
				try
